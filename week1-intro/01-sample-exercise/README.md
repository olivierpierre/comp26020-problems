This is a dummy exercise asking you to create an empty C program.
...
```shell
check50 -l --ansi-log olivierpierre/comp26020-problems/main/week1-intro/01-sample-exercise
```
